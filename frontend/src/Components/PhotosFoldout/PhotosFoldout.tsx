                ...
                <div id='flickr-foldout-label'>
                    <div className='body'>
                        ...
                        <div className='flickr-nav-button-row'>
                            <button
                                className='flickr-nav-button'
                                onClick={() => dispatch({ type: ACTIONS.PREV_PHOTO })}
                            >
                                <i className='fas fa-caret-left' aria-hidden='true'></i> Prev
                            </button>
                            <button
                                className='flickr-nav-button'
                                onClick={() => dispatch({ type: ACTIONS.NEXT_PHOTO })}
                            >
                                Next <i className='fas fa-caret-right' aria-hidden='true'></i>
                            </button>
                        </div>
                        <a
                            id='flickr-button'
